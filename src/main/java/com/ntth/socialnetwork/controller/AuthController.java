...
public class AuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    profileRepository.save(new UserProfile(signUpRequest.getFirstName(), signUpRequest.getLastName(), 
    		...
    		"https://firebasestorage.googleapis.com/v0/b/simple-social-app-593ba.appspot.com/o/avatarImages%2F6596121.png?alt=media&token=63a00dc3-1617-4ef9-af45-af32b3fadc13", 
    		"https://firebasestorage.googleapis.com/v0/b/simple-social-app-593ba.appspot.com/o/backGroundImages%2Fistockphoto-1194212027-612x612.jpg?alt=media&token=a774abe9-7827-4559-b273-3b88b7761469", "", currDate, user, location));
